<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v38">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v38?status.svg" alt="Documentation"/>
    </a>
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v38
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v38.0.0 release artifacts'
$ git tag v38.0.0
```
