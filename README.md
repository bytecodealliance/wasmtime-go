<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v18">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v18?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v18@v18.0.0
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v18
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v18",
    version = "v18.0.0",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v18.0.0 release artifacts'
$ git tag v18.0.0
```
