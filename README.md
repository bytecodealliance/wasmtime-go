<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v44">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v44?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v44@v44.0.1
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v44
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v44.0.0 release artifacts'
$ git tag v44.0.0
```
