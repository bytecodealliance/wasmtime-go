<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v42">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v42?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v42@v42.0.1
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v42
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v42",
    version = "v42.0.1",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v42.0.0 release artifacts'
$ git tag v42.0.0
```
