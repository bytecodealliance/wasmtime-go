<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v43">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v43?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v43@v43.0.1
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v43
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v43",
    version = "v43.0.1",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v43.0.0 release artifacts'
$ git tag v43.0.0
```
