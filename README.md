<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v41">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v41?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v41@v41.0.1
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v41
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v41",
    version = "v41.0.1",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v41.0.0 release artifacts'
$ git tag v41.0.0
```
