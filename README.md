<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v36">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v36?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v36@v36.0.0
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v36
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v36",
    version = "v36.0.0",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v36.0.0 release artifacts'
$ git tag v36.0.0
```
