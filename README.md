<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v20">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v20?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v20@v20.0.0
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v20
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v20",
    version = "v20.0.0",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v20.0.0 release artifacts'
$ git tag v20.0.0
```
