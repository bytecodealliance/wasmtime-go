<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v16">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v16?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v16@v16.0.0
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v16
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v16",
    version = "v16.0.0",
)
```
...
import (
    "fmt"
    "github.com/bytecodealliance/wasmtime-go/v16"
)
