<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v40">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v40?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v40@v40.0.1
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v40
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v40",
    version = "v40.0.1",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v40.0.0 release artifacts'
$ git tag v40.0.0
```
