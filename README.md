<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v37">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v37?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v37@v37.0.0
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v37
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v37",
    version = "v37.0.0",
)
```
...
$ python3 ci/download-wasmtime.py
$ git add .
$ git commit -m 'v37.0.0 release artifacts'
$ git tag v37.0.0
```
