<div align="center">
  ...
  <p>
    ...
    <a href="https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v11">
      <img src="https://godoc.org/github.com/bytecodealliance/wasmtime-go/v11?status.svg" alt="Documentation"/>
    </a>
...
```sh
go get -u github.com/bytecodealliance/wasmtime-go/v11@v11.0.0
```
...
[api]: https://pkg.go.dev/github.com/bytecodealliance/wasmtime-go/v11
...
go_repository(
    ...
    importpath = "github.com/bytecodealliance/wasmtime-go/v11",
    version = "v11.0.0",
)
```
